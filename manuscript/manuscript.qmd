...
<!-- ADD IN CODE SO IT RE-RUNS ON RENDER -->
...
![Field sampling locations](images/fig1_map.jpg){#fig-map width=100%}
...
![Comparison of fluorometers by waterbody](images/fig2_chla_scatter.jpg){#fig-chlascatter width=80%}
...
![Comparison of phycocyanin measurements by waterbody](images/fig3_phyco_scatter.jpg){#fig-phycoscatter width=80%}
...
![Compare Relative Biovolume of divisions by waterbody](images/fig4_rel_bio_bar.jpg){#fig-relbv width=80%}

![Compare Total Biovlume of divisions by waterbody](images/fig5_total_bio_bar.jpg){#fig-bv width=80%}
...
![Compare fluorometer chlorophyll to cyanobacteria cell counts](images/fig6_chl_vs_cells.jpg){#fig-chlcount width=80%}

![Compare fluorometer phycocyanin to cyanobacteria cell counts](images/fig7_phyco_vs_cells.jpg){#fig-phycocount width=80%}
