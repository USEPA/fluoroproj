...
The goal of this paper is to compare different handheld or in situ fluorometers with respect to a common benchmark (extracted chlorophyll and phycocyanin) in order to assess the feasibility of combining data from these various sources.
